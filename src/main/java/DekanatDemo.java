...
public class DekanatDemo{
    public static void main(String[]args){
        ...
        URL gr = System.class.getResource("/group.txt");
        URL st = System.class.getResource("/student.txt");
        Dekanat dek1=new Dekanat(gr,st);
        dek1.setMarks();
        dek1.choiseHeads();
...
class Dekanat{
    ...
    public void addGroups(URL gr){
        String[]group = new String[0];
        try{
            FileInputStream fileGroup=new FileInputStream(new File(gr.getFile()));
    ...
    public void addStudents(URL st){
        String[]student = new String[0];
        String string;
        try{
            FileInputStream fileStudents = new FileInputStream((new File(st.getFile())));
